...
# http://docs.sqlalchemy.org/en/rel_0_9/orm/tutorial.html#tutorial-delete-cascade
# http://docs.sqlalchemy.org/en/rel_0_9/orm/basic_relationships.html#relationship-patterns
