...
if __name__ == '__main__':
    ...
    # remove_duplicate_files('D:\\to hard\\mp3')
    ...
    # remove_duplicate_files('/home/azh/Documents/temp mp3/Untitled Folder')
    remove_duplicate_files('/home/azh/Downloads/Telegram Desktop')
