...
if __name__ == "__main__":
    ...
    print(interpreted_class.some_property)                  # is using some_property instead of SomeProperty

    interpreted_class.some_property = "Newly set property"
    print(interpreted_class.some_property)                  # is using some_property instead of SomeProperty

    interpreted_class.some_method("Argument to some_method")    # is using some_method instead of SomeMethod
