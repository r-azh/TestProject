...
with concurrent.futures.ThreadPoolExecutor(max_workers=3) as crawler_linke_threads:
    future_tasks = {crawler_linke_threads.submit(crawl_task, url): url for url in result_dict.keys()}
