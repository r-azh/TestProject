...
from multiprocessing import Queue, Process, Pool, cpu_count, current_process, Manager
...
def consumer_task(q, fibo_dict):
 ...
 # Manager is a type of object that allows sharing Python objects among different processes by means of proxies
