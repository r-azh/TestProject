...
path_ = os.sep.join(['C:', '_Data_', 'topc', 'ML data', 'ch04', 'ap'])
if not os.path.exists(f'{path_}/ap.dat'):
    print(f'Error: Expected data to be present at {path_}/ap/')
    print('Please cd into ./data & run ./download_ap.sh')

# Load the data
corpus = corpora.BleiCorpus(f'{path_}/ap.dat', f'{path_}/vocab.txt')
