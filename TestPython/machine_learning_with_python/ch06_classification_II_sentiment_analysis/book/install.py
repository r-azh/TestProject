...
from TestPython.machine_learning_with_python.ch06_classification_II_sentiment_analysis.book.twitterauth import CONSUMER_KEY, CONSUMER_SECRET, ACCESS_TOKEN_KEY, ACCESS_TOKEN_SECRET
