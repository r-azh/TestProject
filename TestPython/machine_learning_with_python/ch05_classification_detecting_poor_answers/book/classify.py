...
from TestPython.machine_learning_with_python.ch05_classification_detecting_poor_answers.book.data import chosen, \
    chosen_meta
from TestPython.machine_learning_with_python.ch05_classification_detecting_poor_answers.book.utils import plot_pr, \
    plot_feat_importance, load_meta, fetch_posts, plot_feat_hist, plot_bias_variance, plot_k_complexity, plot_roc
...
for idx, feat in enumerate(feature_names):
    plot_feat_hist([([int(x) for x in qa_X[:, idx]], feat)])
